...
//******************************************************************************
procedure TCad_Endereco.Action1Execute(Sender: TObject);
begin
btnEndCancelar.Click
end;

//******************************************************************************
procedure TCad_Endereco.Action2Execute(Sender: TObject);
begin
btnEndSalvar.Click;
end;
