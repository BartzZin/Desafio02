...
type
  TCad_ClienteEndereco = class(TForm)
    ...
    procedure AC_F5Execute(Sender: TObject);
...
//******************************************************************************
procedure TCad_ClienteEndereco.AC_F5Execute(Sender: TObject);
begin
btnCliNovo.Click;
end;

procedure TCad_ClienteEndereco.AC_F8Execute(Sender: TObject);
begin
btnCliEditar.Click;
end;

procedure TCad_ClienteEndereco.AC_F7Execute(Sender: TObject);
begin
btnCliExcluir.Click;
end;
